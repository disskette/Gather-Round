...
QT_MOC_LITERAL(1, 11, 11), // "startMaster"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6), // "roomId"
QT_MOC_LITERAL(4, 31, 11), // "startPlayer"
QT_MOC_LITERAL(5, 43, 12), // "openIdDialog"
QT_MOC_LITERAL(6, 56, 8) // "isMaster"

    },
    "MenuWindow\0startMaster\0\0roomId\0"
    "startPlayer\0openIdDialog\0isMaster"
};
...
void MenuWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->startMaster((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->startPlayer((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->openIdDialog((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
